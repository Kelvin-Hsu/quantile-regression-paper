...
\section{Kernel Embeddings}
	...
	\subsection{Cross-Covariance Operators}
		...
		\begin{equation}
		\begin{aligned}
			\Cxy g &=  (\expect{\phiX \otimes \psiY}) g \\
			&= \expect{(\phiX \otimes \psiY) g}\\
			&= \expect{\phiX \inner{\psiY}{g}} \\
			&= \expect{g(\rv{Y}) \phiX} \in \mathcal{H}_{k}
			\label{equation:cxy_g}
		\end{aligned}
		\end{equation}	
		
		\begin{equation}
		\begin{aligned}
			\inner{\Cxy g}{f} &= \inner{\expect{g(\rv{Y}) \phiX}}{f} \\
			&= \expect{g(\rv{Y}) \inner{\phiX}{f}} \\
		...
		\begin{equation}
		\begin{aligned}
			\inner{\Cxy}{f \otimes g} &= \inner{\expect{\phiX \otimes \psiY}}{f \otimes g} \\
			&= \expect{\inner{\phiX \otimes \psiY}{f \otimes g}} \\
			&= \expect{\inner{\phiX}{f} \inner{\psiY}{g}} \\
			&= \expect{f(X) g(Y)}
		\end{aligned}
		\end{equation}			
			
		\begin{equation}
			\inner{\Cxy g}{f}_{\mathcal{X}} = \inner{\Cxy}{f \otimes g}_{\mathcal{X} \times \mathcal{Y}} = \inner{\Cyx f}{g}_{\mathcal{Y}}
		\end{equation}
