...
%			
			\begin{definition} \label{def:feature_matrix}
				(Feature Matrix)
				A feature matrix is formed by stacking the corresponding feature vectors \textit{horizontally}, where each feature vector represents a column of that matrix \eqref{eq:feature_matrix}.
