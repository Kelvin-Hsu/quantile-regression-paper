...
\label{sec:direct_quantile_regression}
	...
	\label{sec:direct_quantile_regression:smooth_empirical_distribution}
		...
		\begin{theorem} \label{thm:smooth_empirical_distribution}
...
\label{sec:quantile_regression_algorithms}
	...
	\begin{definition}
		...
		\begin{equation}
			q_{\rv{X}}(\tau) = x : \frac{1}{\Vert \bm{\beta} \Vert} \bm{\beta}^{T} \bvec{K}(\bvec{x}) = \tau
		\end{equation}	
	...
	\begin{definition}
		...
		\begin{equation}
			q_{\rv{X}}(\tau) = x : \bvec{w}^{T} \bvec{K}(\bvec{x}) = \tau
		\end{equation}	
